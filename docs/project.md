...
- **WorkspaceFile** - файлы проекта (ТЗ, сметы, документы)
- **Estimate** - сметы (ТЗ проекта)
- **EstimateColumn** - столбцы сметы (структура таблицы)
- **EstimateRow** - строки сметы
- **Cell** - ячейки таблицы смет (значения)
- **CellHistory** - история изменений ячеек (аудит)
